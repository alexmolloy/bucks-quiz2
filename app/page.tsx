...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 16px' }}>
      <div style={{ maxWidth: 440, width: '100%', textAlign: 'center' }} className="fade-up">
        ...
        <div style={{
          ...
          padding: '4px 14px', borderRadius: '999px', marginBottom: '20px',
        }}>
          BUCKS PARTY QUIZ
        </div>

        <h1 className="font-display" style={{ fontSize: 'clamp(2.8rem, 14vw, 5.5rem)', lineHeight: 1, marginBottom: '8px' }}>
          HOW WELL DO<br />
          <span className="gold">YOU KNOW</span><br />
          {BUCK_NAME.toUpperCase()}?
        </h1>

        <p style={{ color: '#888', marginBottom: '16px', fontSize: 'clamp(0.85rem, 3.5vw, 1rem)', lineHeight: 1.6, padding: '0 8px' }}>
          {MAX_SCORE} points up for grabs.<br />
          Answer well → powerful Pokémon.<br />
          Answer badly → Magikarp. 🐟
        </p>

        {/* Pokeball decoration */}
        <div style={{ margin: '16px auto 20px', width: 52, height: 52 }}>
        ...
        <div className="card" style={{ padding: '24px 20px', textAlign: 'left' }}>
          <label style={{ display: 'block', fontSize: '0.75rem', letterSpacing: '0.12em', color: '#888', marginBottom: '8px' }}>
            YOUR NAME
          </label>
          <input
            type="text"
          ...
          <button
            ...
            style={{ marginTop: '16px', width: '100%', minHeight: 52 }}
            onClick={handleStart}
        ...
        <p style={{ color: '#444', fontSize: '0.72rem', marginTop: '16px' }}>
          Results visible to everyone on the night 🍺
        </p>
      </div>
    </main>
  )
